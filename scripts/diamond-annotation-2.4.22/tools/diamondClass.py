...
class diamondpipe():
    def __init__(self, dbpath="/home/data2/influent_litreview_analyses/nist_meta_workflow/workflow/scripts/diamond-annotation-2.4.22/bin/"):
        self.info = ""
        ...
        try:
            os.popen(" ".join(
                ['diamond',
                 ...
                 '--query-cover',str(data['query_cover']),
                 '-k 1',
                 '-d', db + '.dmnd',
                 '-q', fi,
                 '-a', fi + '.{}'.format(dbpart)
