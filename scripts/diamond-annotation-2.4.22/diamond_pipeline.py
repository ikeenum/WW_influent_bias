...
import base64
import json
sys.path.insert(0, '/home/data2/influent_litreview_analyses/nist_meta_workflow/workflow/scripts/diamond-annotation-2.4.22')
...
def get_parser():
    ...
    parser.add_argument("--query_cover", type=float, default=80,
                        help="minimum query cover for alignments [default 80]",)
    parser.add_argument("--diamond_identity", type=float, default=80,
                        help="minimum identity for alignments [default 80]",)
    parser.add_argument("--diamond_mlen", type=float, default=0,
                        help="diamond minimum length for considering a hit [default 0aa]",)
    ...
    parser.add_argument("--path_to_executables", type=str, default="/diamondannotation/bin/",
                        help="path to ./bin/ under short_reads_pipeline",)
    parser.add_argument("--database", type=str, default="deeparg",
                        help="Choose database: 'deeparg' (for DeepARGdb) or 'vfdb' for the virulence factor database 4.8.2022 or 'card'(for CARD3.0.7) or 'mge' for mobile genetic elements[default deeparg]",)
...
if __name__ == "__main__":
    ...
    diamond_parameters = dict(
        ...
        query_cover=align_par.query_cover
    )
